...
const BidImage: React.FC<Props> = ({image, author, author_name, stock, bid_amount, btn }) => {
  return <div className="flex items-center gap-7 pb-10 last:pb-0">
    <div>
      <img src={image} alt="" />
    </div>
    <div>
      ...
      <div className="flex items-center mb-4">
        ...
        <button className="flex items-center border border-1 border-green-500 text-green-500 rounded-md py-1 px-2 mr-3"><FaEthereum className="mr-1"/>{bid_amount}</button>
