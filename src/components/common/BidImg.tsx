  ...
  return <div className="flex items-center gap-7">
    ...
    <div>
      ...
      <div className="flex items-center mb-3">
        ...
        <button className="border border-1 border-green-500 text-green-500 rounded-md py-1 px-2 mr-3">{bid_amount}</button>
        <span className="text-sm text-paragraph">{stock}</span>
      </div>
      <button className="border border-1 border-primary hover:border-primary hover:bg-primary rounded-full text-primary px-3 py-2 transition-all hover:text-white">{btn}</button>
    </div>
  </div>;
};
